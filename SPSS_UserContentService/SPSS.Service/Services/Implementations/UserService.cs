...
public class UserService : IUserService
{
    ...
    public async Task<UserDto> GetByEmailAsync(string email)
    {
        ...
        // [SỬA ĐỔI] Sử dụng hằng số cụ thể và chính xác hơn
        if (user == null)
            throw new KeyNotFoundException(string.Format(ExceptionMessageConstants.User.NotFoundByEmail, email));
    ...
    public async Task<UserDto> GetByUserNameAsync(string userName)
    {
        ...
        // [SỬA ĐỔI] Sử dụng hằng số mới
        if (user == null)
            throw new KeyNotFoundException(string.Format(ExceptionMessageConstants.User.NotFoundByUsername, userName));
    ...
    public async Task<UserDto> CreateAsync(UserForCreationDto? userForCreationDto)
    {
        ...
        if (userForCreationDto == null)
            throw new ArgumentNullException(nameof(userForCreationDto), ExceptionMessageConstants.User.UserDataNull);
    ...
    public async Task<UserDto> UpdateAsync(Guid userId, UserForUpdateDto userForUpdateDto)
    {
        ...
        if (userForUpdateDto == null)
            throw new ArgumentNullException(nameof(userForUpdateDto), ExceptionMessageConstants.User.UserDataNull);
